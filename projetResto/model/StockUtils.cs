...
public class StockUtils
{
        ...
        public static StockUtils Instance
        {
            get
            {
                lock (padlock)
        ...
        public bool SubstractUtils(string Utils)
        {
            bool exist = this.clean.TryGetValue(Utils, out int eNumber);
            if ((exist) && (eNumber > 0))
            {
                this.clean[Utils] = eNumber - 1;
                return true;
            }
            return false;
        }
